...
def update_mds_serverclass(splunk_home, forwarder):
    ...
    apps_list = ['00_sx_fwd0x_hf_outputs_to_aws_prod_ssl', '00_sx_fwd0x_hf_outputs_to_aws_prod_indexer_discovery']
...
def copy_new_apps(working_dir, zone='MDS'):
    ...
    apps_list = ['00_zoneName_hf_outputs_to_aws_prod_ssl', '00_zoneName_hf_outputs_to_aws_prod_indexer_discovery']
...
if host_type == 'MDS_HF':
    ...
    new_output_dir = '{}/etc/apps/00_sx_fwd0x_hf_outputs_to_aws_prod_indexer_discovery'.format(splunk_home)
